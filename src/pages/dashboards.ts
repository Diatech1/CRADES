...
document.addEventListener('DOMContentLoaded', () => {
  const cfgs = [
    { id: 'chart-dashboard-industriel', label: '${t("Production industrielle", "Industrial production", lang)}', data: [98,102,105,108,112,115,118,121,119,123,125,127], color: '#1e3a5f' },
    ...
    { id: 'chart-dashboard-ipp', label: '${t("Indice des prix", "Price index", lang)}', data: [100,101.2,102.5,103.1,103.8,104.2,105.1,105.8,106.2,106.9,107.5,108.1], color: '#162d4a' },
  ];
  cfgs.forEach(c => {
