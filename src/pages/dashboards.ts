...
document.addEventListener('DOMContentLoaded', () => {
  const cfgs = [
    ...
    { id: 'chart-dashboard-pme', label: '${t("Créations PME", "SME creations", lang)}', data: [320,380,410,350,420,460,480,510,490,530,550,580], color: '#3a7fd4' },
    { id: 'chart-dashboard-ipp', label: '${t("Indice des prix", "Price index", lang)}', data: [100,101.2,102.5,103.1,103.8,104.2,105.1,105.8,106.2,106.9,107.5,108.1], color: '#032d6b' },
  ];
  cfgs.forEach(c => {
