...
document.addEventListener('DOMContentLoaded', () => {
  const cfgs = [
    { id: 'chart-dashboard-industriel', label: '${t("Production industrielle", "Industrial production", lang)}', data: [98,102,105,108,112,115,118,121,119,123,125,127], color: '#261CC1' },
